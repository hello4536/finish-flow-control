  ...
  return <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-12">
        <div className="md:col-span-5">
          <Card>
            <CardHeader>
              <CardTitle className="text-blue-600">Assign New Task</CardTitle>
              <CardDescription>
                Create and assign daily tasks to employees
              </CardDescription>
            </CardHeader>
            <CardContent>
              <TaskAssignmentForm selectedDate={selectedDate} onTaskAssigned={assignTask} />
            </CardContent>
          </Card>
        </div>
        
        <div className="md:col-span-7">
          <DailyTasksList tasks={tasks} selectedDate={selectedDate} isLoading={isLoading} onTaskComplete={completeTask} onTaskDelete={deleteTask} />
        </div>
      </div>
    </div>;
};
