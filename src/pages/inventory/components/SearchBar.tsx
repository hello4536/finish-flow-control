            ...
            <div className="grid gap-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="space-y-1">
                  ...
                  <Select 
                    value={filters.hazardClass || "All"} 
                    onValueChange={(value) => handleFilterChange("hazardClass", value)}
                  >
              ...
              <div className="space-y-1">
                ...
                <Slider 
                  id="vocContent"
                  defaultValue={[filters.minVoc || 0, filters.maxVoc || 1000]}
                  min={0}
                  max={1000}
                  step={10}
                  onValueChange={(value) => {
              ...
              <div className="space-y-1">
                ...
                <Select 
                  value={filters.isConsumable === null ? "all" : filters.isConsumable ? "consumable" : "durable"} 
                  onValueChange={(value) => {
                    handleFilterChange(
                      "isConsumable", 
                      value === "all" ? null : value === "consumable"
                    );
                  }}
                >
