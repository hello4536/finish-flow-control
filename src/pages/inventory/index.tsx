...
const InventoryPage: React.FC = () => {
  ...
  return <div className="container mx-auto">
      ...
      <StatCards totalProducts={inventoryItems.length} categoryCount={categoryCount} lowStockCount={lowStockCount} warehouseCount={warehouses.length} />
