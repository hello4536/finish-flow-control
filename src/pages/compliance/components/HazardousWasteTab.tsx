...
const HazardousWasteTab: React.FC<HazardousWasteTabProps> = ({ 
  ...
  const filteredWaste = filterStatus 
    ? hazardousWaste.filter(item => item.status === filterStatus)
    : hazardousWaste;
        ...
        <div className="flex gap-2">
          <div className="flex gap-1">
            ...
            <Button 
              ...
              variant={filterStatus === "Disposed" ? "default" : "outline"}
              size="sm"
            >
              Disposed
            </Button>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        <Button 
                          variant="ghost" 
                          size="icon"
                          onClick={() => handleGenerateManifest(waste.id)} 
      ...
      <div className="mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {hazardousWaste
            ...
            .slice(0, 3)
            .map(waste => (
              <div key={`upcoming-${waste.id}`} className="border rounded-md p-3 bg-yellow-50">
