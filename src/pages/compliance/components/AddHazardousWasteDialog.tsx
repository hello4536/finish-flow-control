...
const formSchema = z.object({
  waste_id: z.string().min(1, { message: "Waste ID is required" }),
  material: z.string().min(1, { message: "Material is required" }),
  quantity: z.string().min(1, { message: "Quantity is required" }),
  unit: z.string().min(1, { message: "Unit is required" }),
  disposal_date: z.string().min(1, { message: "Disposal date is required" }),
  disposal_method: z.string().min(1, { message: "Disposal method is required" }),
  handler: z.string().min(1, { message: "Handler is required" }),
...
const AddHazardousWasteDialog: React.FC<AddHazardousWasteDialogProps> = ({ onAddHazardousWaste }) => {
