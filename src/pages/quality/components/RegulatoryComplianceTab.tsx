...
const RegulatoryComplianceTab: React.FC<RegulatoryComplianceTabProps> = ({
  ...
  const { requirements, jurisdictions, complianceMatrix } = useMemo(() => {
    ...
    return { requirements, jurisdictions, complianceMatrix: matrix };
  }, [regulatoryCompliance]);
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center mb-4">
          <div className="flex flex-col">
            <h3 className="text-lg font-medium">Regulatory Compliance Checklist</h3>
          ...
          <div className="flex items-center space-x-2">
            ...
            <ToggleGroup 
              ...
              onValueChange={(value) => value && onRegionChange(value as Region)}
            >
              <ToggleGroupItem value="US">US</ToggleGroupItem>
              <ToggleGroupItem value="Canada">Canada</ToggleGroupItem>
                  ...
                  <TableHeader>
                    <TableRow>
                      ...
                      {jurisdictions.map(jurisdiction => (
                        <TableHead key={jurisdiction} className="min-w-[150px] text-center">
                          {jurisdiction}
                        </TableHead>
                      ))}
                    </TableRow>
                  ...
                  <TableBody>
                    {requirements.map(requirement => (
                      <TableRow key={requirement}>
                        ...
                        {jurisdictions.map(jurisdiction => (
                          <TableCell key={`${requirement}-${jurisdiction}`} className="text-center">
