...
const formSchema = z.object({
  equipmentId: z.string({ required_error: "Equipment is required" }),
  maintenanceType: z.string({ required_error: "Maintenance type is required" }),
  performedBy: z.string({ required_error: "Performed by is required" }),
...
const AddMaintenanceDialog: React.FC<AddMaintenanceDialogProps> = ({ open, onOpenChange }) => {
  const { equipment, isLoading: loadingEquipment } = useEquipment();
  const { addMaintenanceRecord } = useEquipmentMaintenance();
