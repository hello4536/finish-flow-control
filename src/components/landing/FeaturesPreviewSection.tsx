...
const FeaturesPreviewSection = () => {
  ...
  return <section id="features" className="bg-gradient-to-b from-white to-gray-50 py-[66px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {previewFeatures.map((feature, index) => <div key={index} className="group relative p-6 bg-white rounded-2xl border border-gray-100 hover:shadow-xl hover:shadow-blue-100/50 transition-all duration-300 hover:-translate-y-1">
