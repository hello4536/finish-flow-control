      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="text-center mt-12">
          ...
          <p className="mt-2 text-muted-foreground mb-8">
            Sign up today and experience the benefits of Finivi.
          </p>
          <a 
            href="/auth/signup" 
            className="inline-flex items-center rounded-full bg-accent text-accent-foreground hover:bg-accent/90 h-12 px-8 py-2 text-lg font-medium transition-colors"
          >
            Get Started
          </a>
        </div>
