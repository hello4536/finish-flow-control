...
interface FeatureTab {
  ...
  altText: string;
  description: string;
  features: { text: string; score?: number }[];
  benefits: string[];
}
  ...
  const featureTabs: FeatureTab[] = [
    {
      ...
      features: [
        { text: "Schedule jobs and assign tasks to team members", score: 90 },
        { text: "Track progress with real-time status updates", score: 85 },
        { text: "Manage deadlines and prioritize work efficiently", score: 92 },
        { text: "Generate detailed job reports and analytics", score: 88 }
      ],
      benefits: [
    ...
    },
    {
      ...
      features: [
        { text: "Monitor stock levels with automated alerts", score: 94 },
        { text: "Track material usage across different jobs", score: 87 },
        { text: "Manage warehouse locations and organization", score: 83 },
        { text: "Generate inventory reports and forecasts", score: 90 }
      ],
      benefits: [
    ...
    },
    {
      ...
      features: [
        { text: "Track certifications and renewal dates", score: 100 },
        { text: "Manage PPE requirements and inventory", score: 85 },
        { text: "Monitor hazardous waste handling procedures", score: 92 },
        { text: "Generate compliance reports for audits", score: 89 }
      ],
      benefits: [
    ...
    },
    {
      ...
      features: [
        { text: "Save and organize custom color formulas", score: 96 },
        { text: "Share recipes across team members", score: 87 },
        { text: "Track ingredient usage and inventory", score: 88 },
        { text: "Document application methods and techniques", score: 94 }
      ],
      benefits: [
    ...
    },
    {
      ...
      features: [
        { text: "Track inspections and quality checks", score: 97 },
        { text: "Document quality issues with photos", score: 85 },
        { text: "Assign and monitor corrective actions", score: 90 },
        { text: "Generate quality performance reports", score: 88 }
      ],
      benefits: [
    ...
    },
    {
      ...
      features: [
        { text: "Create step-by-step process templates", score: 95 },
        { text: "Track workflow completion and timing", score: 87 },
        { text: "Assign tasks to specific team members", score: 92 },
        { text: "Optimize processes with workflow analytics", score: 90 }
      ],
      benefits: [
    ...
    },
    {
      ...
      features: [
        { text: "View key performance metrics in real-time", score: 98 },
        { text: "Track job progress across departments", score: 92 },
        { text: "Monitor material usage and inventory levels", score: 87 },
        { text: "Identify bottlenecks and optimization opportunities", score: 94 }
      ],
      benefits: [
