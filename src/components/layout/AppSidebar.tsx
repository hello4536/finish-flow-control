...
export function AppSidebar() {
  ...
  // Updated function to generate NavLink classes with orange-100 background for active items
  const getNavCls = (item: {
    ...
    return ({
      ...
      // Active state with orange-100 background and navy text
      if (isActive) {
        return `${baseClasses} bg-orange-100 text-primary font-medium shadow-md`;
      }
